...
for(var i = 0; i<buttons.length; i++ ){
    ...
    currentButton.addEventListener('click', printXorZero);//Call back function
}
var isGameEnd = false;
var flag = true;
var count = 0;
...
function printXorZero(){
    ...
    //alert("Clicked Happen");//Check weather code is happening or not
    if(!isGameEnd && currentButton.innerText.trim().length==0){
        count ++;
    var value = flag?"X":"0";//if flag true gives X , if not gives 0
